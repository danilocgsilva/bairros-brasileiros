...
class Receitas(Conexao):
    def salva(
        ...
        query = "INSERT INTO receitas (nome, seletor_tabela, seletor_coluna, endereco, tipo_localidade, localidade_pai) VALUES (%s, %s, %s, %s, %s, %s);"
    ...
    def buscar_por_id(self, id: int) -> Receita:
        query = "SELECT id, nome, seletor_tabela, seletor_coluna, endereco, tipo_localidade, localidade_pai FROM receitas WHERE id = %s;"
        local_cursor = self.recursodb.cursor()
    ...
    def todas(self) -> list:
        query = "SELECT id, nome, seletor_tabela, seletor_coluna, endereco, tipo_localidade, localidade_pai FROM receitas;"
        local_cursor = self.recursodb.cursor()
